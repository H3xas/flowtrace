 ...
 * one — and the mode its facts merge with the extraction under.
 *
...
export function validateConfig(raw, { baseDir = process.cwd(), file = CONFIG_FILENAME, env = process.env } = {}) {
  ...
  return { file, out: resolve(baseDir, out), repos, aliases, scout, sinks, caseId, workerPatterns, scaffold, split };
}
