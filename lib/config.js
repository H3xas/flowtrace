 ...
 * and config-read patterns, since only public idioms are built in, and the trace step
 * with the framework's own consumer entry-method names. Optional per-repository
 ...
 * method names and is validated as such; `docs/configuration.md` describes what each one
