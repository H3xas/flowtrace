 ...
 * strings validated as regex sources (`consumerEntryMethods` holds plain method names,
 * which are valid ones); `docs/configuration.md` describes what each one matches and
 * which capture groups the whole-regex fields must expose.
 */
