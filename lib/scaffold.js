 ...
 * replace — and a caller may pass the same shape through the API. `importAliases.caseId`
 * is unset by default; a harness that sets it, with a matching `caseIdPlaceholder`, gets
