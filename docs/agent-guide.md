...
packets, have it verdict the golden set under `examples/demo-shop/calibration` and run
`flowtrace calibrate --golden <that directory> --verdicts <its output>`. Exit `0` means
